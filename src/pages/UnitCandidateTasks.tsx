  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="max-w-[1600px]">
        {/* Main Content Grid */}
        <div className="flex">
          <div className="flex-1 mx-20 my-7">
            {/* back button */}
            <button
              className="mb-7 flex items-center gap-2 text-gray-600 hover:text-gray-800 border border-gray-300 rounded-lg px-3 py-1.5 bg-white "
              onClick={() => navigate(-1)}
            >
          ...
          <div className="border-l-4 bg-white">
            {/* Tasks List Sidebar */}
            <div className="w-full md:w-80  p-6 shadow-inner flex flex-col border-gray-300">
